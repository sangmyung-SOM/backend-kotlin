...
class GameMalTests {
	...
	public fun 말움직이기_빽도_테스트2(){
		...
		println("빽도: mal.getPosition() = ${mal.getPosition()}, 도착 = ${mal.isEnd()}") // 0
		Assertions.assertEquals(mal.getPosition(), 19)
	}

	@Test
	public fun 말움직이기_빽도_테스트3(){
		// 모 -> 걸 -> 걸 -> 빽도
		val mal : Mal = Mal(0)
		...
		println("빽도: mal.getPosition() = ${mal.getPosition()}, 도착 = ${mal.isEnd()}") // 0
		Assertions.assertEquals(mal.getPosition(), 30)
	}

	@Test
	public fun 말움직이기_빽도_테스트4(){
		// 모 -> 모 -> 모 -> 도 -> 빽도
		val mal : Mal = Mal(0)
		...
		println("빽도: mal.getPosition() = ${mal.getPosition()}, 도착 = ${mal.isEnd()}") // 0
		Assertions.assertEquals(19, mal.getPosition())
	}

	@Test
	public fun 말움직이기_빽도_테스트5(){
		// 윷 -> 모 -> 도 -> 걸 -> 빽도
		val mal : Mal = Mal(0)
	...
	public fun 말움직이기_빽도_테스트6(){
		...
		println("빽도: mal.getPosition() = ${mal.getPosition()}, 도착 = ${mal.isEnd()}") // 0
		Assertions.assertEquals(22, mal.getPosition())
	}
